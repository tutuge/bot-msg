<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="提现网络" prop="networkName">
        <el-input
    ...
    <el-table v-loading="loading" :data="networkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="提现网络(别名)" align="center" prop="aliasName" />
      <el-table-column label="提现网络" align="center" prop="networkName" />
      <el-table-column label="手续费" align="center" prop="serviceCharge" />
      <!-- <el-table-column label="最低提现USDT" align="center" prop="minWithdrawal" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="提现网络(别名)" prop="aliasName">
          <el-input v-model="form.aliasName" placeholder="请输入提现网络别名" />
        </el-form-item>
        <el-form-item label="提现网络" prop="networkName">
          <el-input v-model="form.networkName" placeholder="请输入提现网络" />
        </el-form-item>
        <el-form-item label="提现手续费" prop="serviceCharge">
          <el-input v-model="form.serviceCharge" placeholder="ERC20网络手续费需要从链上获取请填写*，其他网络请维护固定数值" />
        </el-form-item>
        <!-- <el-form-item label="最低提现额" prop="minWithdrawal">
          <el-input v-model="form.minWithdrawal" placeholder="请输入最低提现额，USDT为单位" />
        </el-form-item> -->
  ...
  data() {
    return {
      ...
      rules: {
        ...
        networkName: [
          { required: true, message: "提现网络不能为空", trigger: "blur" }
        ],
        aliasName: [
          { required: true, message: "提现网络别名不能为空", trigger: "blur" }
        ],
        address: [
        ...
        minWithdrawal: [
          { required: true, message: "请设置最低提现额", trigger: "blur" }
        ],
      }
    };
  },
