...
public class IPSeekerUtil {
    ...
    private final MappedByteBuffer buffer; // 内存映射文件,提高IO 读取效率

    private final HashMap<String, IPLocation> cache = new HashMap<>(); // 用来做为cache，查询一个ip时首先查看cache，以减少不必要的重复查找

    private final int ipBegin;
